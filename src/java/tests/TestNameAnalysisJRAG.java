...
public class TestNameAnalysisJRAG extends AbstractParameterizedTest {
	/**
	 * Directory where test files live
	 */
	private static final String TEST_DIR = "testfiles/nameanalysisJ";

	/**
	 * Construct a new JastAdd test
	 * @param filename filename of test input file
	 */
	public TestNameAnalysisJRAG(String filename) {
